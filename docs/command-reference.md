...
| `add-broll` | `capcut add-broll <project> <file-or-url> <start> [duration] [options]` | yes | Add a video/image that always renders above every other video track, muted by default. |
